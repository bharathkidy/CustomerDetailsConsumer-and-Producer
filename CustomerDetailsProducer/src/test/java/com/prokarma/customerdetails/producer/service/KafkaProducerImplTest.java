...
class KafkaProducerImplTest {
  ...
  @Test
  void testPostKafkaWithSuccessfulPostingExpctedHttpStatus500()
    ...
    assertEquals(HttpStatus.OK,
        kafkaProducerImpl
            .postKafka(MessageConverterUtil.getMessage(new CustomerDetailsRequest(), ""))
            .getStatusCode());
  ...
  @Test
  void testPostKafkaWithUnSuccessfulPostingExpctedThrowingGeneralException()
      throws InterruptedException, ExecutionException, TimeoutException {

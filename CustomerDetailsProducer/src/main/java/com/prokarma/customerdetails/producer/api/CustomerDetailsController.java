...
public class CustomerDetailsController {
  ...
  public ResponseEntity<Object> postCustomerDetails(
    ...
    Message<CustomerDetailsRequest> message =
        MessageConverterUtil.getMessage(customerDetailsRequest, topic);

    return kafkaProducer.postKafka(message);
